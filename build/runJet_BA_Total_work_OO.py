...
MAINGENERATOR = "run_config_files_nEvents_100K_OO_5360GeV_type_6_default"
wantDir = "config_files_nEvents_100K_OO_5360GeV_type_6_default"
TOTAL_EVENTS = 100
...
def write_condor_submit(
    ...
    hydro_source = pathlib.Path(main_dir) / "hydro_files_OO"
    if not hydro_source.exists():
        raise FileNotFoundError(f"hydro_files_OO directory not found at {hydro_source}")
